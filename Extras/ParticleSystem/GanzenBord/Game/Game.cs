...
namespace Ganzenbord
{
    class Game
    {
        ...
        public static void PlayGame()
        {
            ...
            ConsoleRenderer myConsoleRenderer = new ConsoleRenderer(90, 60);

            GameLoop(myGame, myConsoleRenderer);
        }
        static void GameLoop(Game myGame, ConsoleRenderer Renderer)
        {
            string playerInput = "";
            Renderer.Render(myGame);
            Console.SetCursorPosition(0, 35);
            Console.ForegroundColor = ConsoleColor.White;
            while (playerInput != "q")
            {
                myGame.PlayTurn(playerInput);
                playerInput = Renderer.Render(myGame);
            }
        }
